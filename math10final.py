...
model.summary()
st.pyplot(fig)
st.write("There was a certain deviation in the fitting results, which was caused by the fact that the injection magnitude of Johnson & Johnson was one order of magnitude lower than the other two. Therefore, Pfizer and Modena were still the mainstream of local inoculation.")
