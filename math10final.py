...
df = pd.read_csv("/Users/shimingyu/Desktop/math10final/covid19vaccinesbycounty.csv",na_values = " ")
...
model.summary()
st.pyplot(fig)
st.write("Because J&J takes only one shot to complete all vaccinations, and because it has the largest regression coefficient, it is generally believed to be the decisive factor for full vaccination rates. However, due to the large fitting error, this conjecture was denied. Since the injection volume of the other two vaccines was an order of magnitude higher than that of Johnson & Johnson, it was the other two vaccines that played a decisive role.")
...
image = Image.open('/Users/shimingyu/Desktop/math10final/meme.jpg')
if meme:
